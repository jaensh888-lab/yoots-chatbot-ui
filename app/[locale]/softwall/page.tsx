  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-6 p-6">
      ...
      <p className="text-muted-foreground text-center max-w-[560px]">
        Можно просто попробовать без регистрации. Позже попросим создать аккаунт, чтобы сохранить прогресс.
      </p>
      ...
      <button
        ...
        disabled={busy}
        className="rounded-xl px-5 py-2.5 bg-blue-600 text-white hover:bg-blue-500 disabled:opacity-50"
      >
